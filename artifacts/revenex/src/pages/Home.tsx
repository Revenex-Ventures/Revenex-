...
function HowItWorksSection({ language }: { language: string }) {
  ...
  // Map vertical scroll progress to horizontal translation of the steps wrapper
  // We slide the track left as the user scrolls down
  ...
  const timelineItems = [
    {
      ...
      detail: language === 'en' ? "We schedule a short requirements call to understand your institution's specific modules, grading rules, and administrative workflows." : "हम आपके संस्थान की आवश्यकताओं को समझने के लिए एक संक्षिप्त डेमो कॉल निर्धारित करते हैं।",
      badge: language === 'en' ? "Phase 01: Connect" : "चरण 01: संपर्क",
      icon: MessageSquare,
      tags: ['Free Demo', 'Requirement Mapping', 'SLA Forecasts'],
      color: '#8B4513',
      iconBg: 'linear-gradient(135deg, #F0E8DC, #E8DDD0)',
      iconColor: '#8B4513',
      bullets: language === 'en' ? [
        "School size & grading systems discovery",
        "Tailored platform demonstration call",
        "Free sandbox configuration mapping"
      ] : [
        "स्कूल के आकार और ग्रेडिंग सिस्टम की खोज",
        "अनुकूलित प्लेटफॉर्म प्रदर्शन कॉल",
        "निःशुल्क सैंडबॉक्स कॉन्फ़िगरेशन मैपिंग"
      ],
      preview: (
        <div className="bg-[#FDFBF7] border border-[#E8E0D4] rounded-2xl p-4 shadow-sm space-y-2 text-left relative overflow-hidden group w-full">
          ...
          <div className="space-y-1">
            ...
            <div className="text-[9px] text-[#6B5D52] flex items-center gap-1.5 font-semibold">
              <Calendar className="w-3.5 h-3.5 text-[#8B4513]" /> Today @ 03:30 PM (15m Call)
            </div>
          </div>
        </div>
      )
    },
    {
      ...
      desc: language === 'en' ? "We set up the platform to match your rules." : "हम आपके नियमों के अनुसार प्लेटफॉर्म सेट करते हैं।",
      detail: language === 'en' ? "We migrate your legacy student records, spreadsheets, and files. Then we brand the interface, domain, and fee ledgers to match your guidelines." : "हम डेटाबेस माइग्रेट करते हैं, लोगो सेट करते हैं और डोमेन लिंक करते हैं।",
      badge: language === 'en' ? "Phase 02: Setup" : "चरण 02: सेटअप",
      icon: Settings2,
      tags: ['Data Migration', 'Domain Mapping', 'Brand Accent Colors'],
      color: '#7C3D0F',
      iconBg: 'linear-gradient(135deg, #1A1410, #3D2810)',
      iconColor: '#FFFFFF',
      bullets: language === 'en' ? [
        "Spreadsheets data import (zero loss)",
        "Logo & school domains configuration",
        "Grade structure & rules customization"
      ] : [
        "स्प्रेडशीट डेटा आयात (शून्य हानि)",
        "लोगो और स्कूल डोमेन कॉन्फ़िगरेशन",
        "ग्रेड संरचना और नियम अनुकूलन"
      ],
      preview: (
        <div className="bg-[#FDFBF7] border border-[#E8E0D4] rounded-2xl p-4 shadow-sm space-y-3 text-left relative overflow-hidden w-full">
          <div className="absolute top-0 right-0 w-24 h-24 bg-[#7C3D0F]/5 rounded-full blur-xl pointer-events-none" />
          <div className="flex justify-between items-center pb-2 border-b border-[#E8E0D4]/60">
            <span className="text-[9px] font-black text-[#7C3D0F] uppercase tracking-wider">Database Migration</span>
            <span className="text-[8px] text-[#C4722A] bg-amber-50 px-1.5 py-0.5 rounded-full font-bold">92% Synced</span>
          </div>
          <div className="space-y-1.5">
            <div className="flex justify-between text-[10px] font-bold text-[#1A1410]">
              <span>Student Admissions</span>
              <span>1,240 records</span>
            </div>
    ...
    {
      step: "03",
      title: language === 'en' ? "Staff Onboarding" : "कर्मचारी प्रशिक्षण",
      desc: language === 'en' ? "We train your staff and provide guides." : "हम आपके कर्मचारियों को प्रशिक्षित करते हैं।",
      detail: language === 'en' ? "We conduct live interactive video training for your teachers, fee collectors, and admin staff to ensure they are fully ready to manage portals." : "हम वीडियो और वेबिनार के माध्यम से आपके कर्मचारियों को प्रशिक्षित करते हैं।",
      badge: language === 'en' ? "Phase 03: Onboard" : "चरण 03: प्रशिक्षण",
      icon: GraduationCap,
      tags: ['Live Video Calls', 'Teacher Guides', 'Permissions Lock'],
      color: '#166534',
      iconBg: 'linear-gradient(135deg, #F0E8DC, #E8DDD0)',
      iconColor: '#8B4513',
      bullets: language === 'en' ? [
        "Live interactive webinar workshops",
        "Role-based permission locks",
        "Step-by-step user manuals & videos"
      ] : [
        "लाइव इंटरैक्टिव वेबिनार कार्यशालाएं",
        "भूमिका-आधारित अनुमति ताले",
        "चरण-दर-चरण उपयोगकर्ता पुस्तिकाएं और वीडियो"
      ],
      preview: (
        <div className="bg-[#FDFBF7] border border-[#E8E0D4] rounded-2xl p-4 shadow-sm space-y-2 text-left relative overflow-hidden w-full">
          <div className="absolute top-0 right-0 w-24 h-24 bg-[#166534]/5 rounded-full blur-xl pointer-events-none" />
          <div className="flex justify-between items-center pb-2 border-b border-[#E8E0D4]/60">
            <span className="text-[9px] font-black text-[#166534] uppercase tracking-wider">Training Portal</span>
            <span className="text-[8px] text-[#166534] bg-green-50 px-1.5 py-0.5 rounded-full font-bold">2/3 Done</span>
          </div>
          <div className="space-y-1.5">
            {[
              { label: "Teacher App Setup", done: true },
              { label: "Fee Ledger Training", done: true },
              { label: "Alert Broadcast Setup", done: false },
            ].map((task, idx) => (
    ...
    {
      step: "04",
      title: language === 'en' ? "Go Live & Support" : "लाइव जाएं और सहायता",
      desc: language === 'en' ? "We launch the system with 24/7 help." : "हम 24/7 सहायता के साथ सिस्टम लॉन्च करते हैं।",
      detail: language === 'en' ? "Deploy to production subdomains under custom SSL security. Benefit from our dedicated customer support manager and SLA updates." : "हम 99.9% अपटाइम सहायता के साथ कस्टम सबडोमेन लाइव तैनात करते हैं।",
      badge: language === 'en' ? "Phase 04: Launch" : "चरण 04: लॉन्च",
      icon: Activity,
      tags: ['Production SUB', 'WhatsApp Helpline', 'Monthly Updates'],
      color: '#166534',
      iconBg: 'linear-gradient(135deg, #1A1410, #3D2810)',
      iconColor: '#FFFFFF',
      bullets: language === 'en' ? [
        "Subdomain launch with SSL",
        "Dedicated account helpline setup",
        "Periodic patches & speed upgrades"
      ] : [
        "एसएसएल के साथ सबडोमेन लॉन्च",
        "समर्पित खाता हेल्पलाइन सेटअप",
        "समय-समय पर पैच और स्पीड अपग्रेड"
      ],
      preview: (
        <div className="bg-[#120E0A] border border-[#8B4513]/25 rounded-2xl p-4 shadow-xl space-y-2.5 text-left text-white relative overflow-hidden w-full">
          ...
          <div className="flex justify-between items-center">
            <div>
              <div className="text-[11px] font-black text-[#F5F0E8]">Subdomain Online</div>
              <div className="text-[8px] text-white/50">dps.revenex.in</div>
            </div>
            <div className="text-right">
              <div className="text-[11px] font-black text-green-400">99.9% Uptime</div>
              <div className="text-[8px] text-white/30">Hotline Active</div>
            </div>
          </div>
        </div>
      )
  ...
  return (
    <section ref={sectionRef} className="relative h-[250vh] bg-[#F5F0E8] border-t border-[#E8E0D4]" id="how-it-works">
      <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-between py-12 lg:py-16">
        <div className="absolute inset-0 bg-[#F0E8DC]/90 backdrop-blur-xs pointer-events-none" />
        
        {/* Fixed Header */}
        <div className="text-center max-w-3xl mx-auto px-4 relative z-20">
          <SectionBadge label="How It Works" />
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#1A1410] tracking-tight leading-tight mt-2">
            {language === 'en'
              ? <>From signup to live — in 4 simple steps.</>
              : <>4 आसान चरणों में शुरू करें।</>}
          </h2>
          <p className="text-[#6B5D52] text-xs sm:text-sm max-w-xl mx-auto mt-2 leading-relaxed font-medium">
            {language === 'en'
              ? 'No complicated setups or contracts. We handle the migration, customization, training, and deployment.'
              : 'कोई जटिल सेटअप नहीं। हम सब कुछ खुद संभालते हैं।'}
          </p>
        </div>

        {/* Horizontal Scroll Track Wrapper */}
        <div className="relative flex items-center overflow-hidden w-full flex-1">
          {/* Background horizontal connecting line */}
          <div className="absolute left-[15vw] right-[25vw] h-[2px] bg-[#E0D4C0] z-0 pointer-events-none" />
          
          <motion.div
            style={{ x }}
            className="flex gap-12 lg:gap-16 items-stretch pl-[15vw] pr-[30vw] z-10"
          >
            {timelineItems.map((item, index) => {
              ...
              return (
                <div
                  key={item.step}
                  className="w-[85vw] md:w-[65vw] lg:w-[50vw] shrink-0 bg-white/80 backdrop-blur-md border border-[#E8E0D4] rounded-[2.5rem] p-6 lg:p-8 shadow-2xl relative overflow-hidden flex flex-col md:flex-row gap-6 items-center justify-between hover:border-[#8B4513] transition-all duration-300"
                >
                  {/* Faint Backdrop step number */}
                  <span className="text-9xl font-black text-[#8B4513]/5 absolute right-6 bottom-0 select-none pointer-events-none font-mono">
                    {item.step}
                  </span>
                  ...
                  <div className="flex-1 text-left space-y-4">
                    <div>
                      ...
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider mb-3 bg-[#1A1410] text-[#FFFFFF]">
                        <Icon className="w-3.5 h-3.5 text-[#E3B581]" />
                        <span>Step {item.step}</span>
                      </div>
                      <h3 className="text-xl font-black text-[#1A1410] leading-snug">
                        {item.title}
                      </h3>
                      <p className="text-xs text-[#6B5D52] font-semibold mt-1">
                        {item.desc}
                      </p>
                    </div>

                    <p className="text-[11px] text-[#6B5D52] leading-relaxed font-medium">
                      {item.detail}
                    </p>

                    {/* Bullet checklist */}
                    <ul className="space-y-2 bg-[#FDFBF7]/60 border border-[#E8E0D4]/40 p-3 rounded-2xl">
                      {item.bullets.map((bullet, idx) => (
                        <li key={idx} className="flex gap-2 items-center text-[10px] text-[#3D3128] font-medium">
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-2">
                      {item.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2.5 py-1 rounded-full text-[9px] font-bold bg-white border border-[#D4C4B0] text-[#3D3128]"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  {/* Right Side: Embedded visual preview widget */}
                  <div className="w-full md:w-[45%] shrink-0 flex items-center justify-center relative">
                    {item.preview}
                  </div>
                </div>
              )
        ...
        {/* Bottom Horizontal Progress Tracker */}
        <div className="mx-auto max-w-md w-full px-8 relative z-20 pb-4">
          <div className="flex justify-between items-center text-[9px] text-[#6B5D52] mb-1.5 font-black uppercase tracking-widest">
            <span>Contact</span>
            <span>ERP Setup</span>
            <span>Training</span>
            <span>Launch</span>
          </div>
          <div className="h-1 w-full bg-[#E0D4C0]/60 rounded-full overflow-hidden">
            <motion.div 
              className="h-full bg-gradient-to-r from-[#8B4513] to-[#C4722A]" 
              style={{ width: useTransform(scrollYProgress, [0, 1], ["5%", "100%"]) }}
            />
          </div>
        </div>
      </div>
